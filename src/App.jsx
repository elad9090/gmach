      ...
      <div style={{ background:route.color,color:"#fff",padding:"14px 16px 12px",flexShrink:0 }}>
        <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between" }}>
          <div style={{ display:"flex",alignItems:"center",gap:8 }}>
            <button onClick={()=>navigate(`/${numCars}cars/pick`)} style={{ background:"rgba(255,255,255,0.2)",border:"none",borderRadius:8,color:"#fff",fontSize:16,cursor:"pointer",padding:"4px 10px" }}>←</button>
            <div>
        ...
        {allDone ? (
          ...
          <>
            ...
            <div style={{ display:"flex",alignItems:"center",gap:10,marginBottom:14 }}>
              <div style={{ width:44,height:44,borderRadius:"50%",background:route.color,color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,fontSize:18,flexShrink:0,boxShadow:`0 4px 12px ${route.color}55` }}>{stopNum}</div>
              <div>
            ...
            <div style={{ background:"#fff",borderRadius:20,border:"2px solid #e5e7eb",overflow:"hidden",boxShadow:"0 4px 20px #0001",marginBottom:14 }}>
              ...
              <div>
                {photo ? (
                  <img src={photo} alt="בית" style={{ width:"100%",height:150,objectFit:"cover",display:"block" }} />
                ) : (
            ...
            <div style={{ display:"flex",gap:10 }}>
              <a href={mapsUrl(addr.name)} target="_blank" rel="noreferrer"
                style={{ flex:1,display:"flex",alignItems:"center",justifyContent:"center",gap:7,padding:"14px 0",borderRadius:14,background:"#eff6ff",border:"2px solid #bfdbfe",color:"#1d4ed8",fontWeight:700,fontSize:15,textDecoration:"none" }}>
                🧭 נווט
              </a>
              <button onClick={markDelivered}
                style={{ flex:2,display:"flex",alignItems:"center",justifyContent:"center",gap:8,padding:"14px 0",borderRadius:14,border:"none",background:"#16a34a",color:"#fff",fontWeight:800,fontSize:16,cursor:"pointer",boxShadow:"0 4px 14px #16a34a55" }}>
                ✓ נמסר — הבא
              </button>
            </div>

            {stopNum>1 && (
              <button onClick={goBack} style={{ marginTop:8,alignSelf:"center",background:"none",border:"none",color:"#9ca3af",fontSize:12,cursor:"pointer",padding:6 }}>
                ↩ חזור לעצירה הקודמת
              </button>
            )}
          </>
